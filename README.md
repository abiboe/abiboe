...
### What I'm building
- 🔴 **Autonomous AI Red Team agents** — real kill-chain execution at machine speed
- 🛡️ **Offensive Vaccines** — using AI attacks to force defensive evolution
- 🤖 **AI × Security** — where LLMs meet penetration testing methodology
- ⚡ **Full-stack systems** — from web apps to cloud infrastructure
...
```
🔴 [RED TEAM]     Autonomous AI red team ops with Decepticon framework
🤖 [AI/ML]        LLM agent pipelines — LangGraph, Ollama, Claude API
🌐 [FULLSTACK]    React • Node.js • Firebase • REST APIs
☁️  [CLOUD]        AWS • GCP • Docker • Kubernetes deployments  
🛡️  [DEFENSE]      Wazuh SIEM • threat detection • incident response
...
![Visitor Count](https://komarev.com/ghpvc/?username=abiboe&color=00ff88&style=flat-square&label=PROFILE+VIEWS)
