...
HANDLE="(Cero)"
ROLE="AI-Powered Red Team Operator"
LOCATION="127.0.0.1 — somewhere behind seven proxies"
FOCUS="Autonomous offensive agents + adversarial ML"
CURRENTLY="Building the Decepticon framework"
...
### 🔴 Decepticon
> Autonomous AI red-team framework that plans and executes kill-chains end to end. Orchestrates LLM agents through recon → exploitation → reporting.
...
### 🛡️ Offensive Vaccines
> Weaponizes controlled AI attacks to stress-test defenses and force detection rules to evolve. Attack simulation as a hardening loop.

`AI/ML` &nbsp;`Wazuh` &nbsp;`Detection Eng`
...
<img src="https://streak-stats.demolab.com/?user=abiboe&theme=chartreuse-dark&hide_border=true&background=0a0a0f&ring=00ff88&fire=ff4444&currStreakLabel=00ff88" />

<br><br>

<img src="https://github-profile-trophy.vercel.app/?username=abiboe&theme=matrix&no-frame=true&no-bg=true&column=7&margin-w=6&margin-h=6" />

<br><br>

<img width="95%" src="https://github-readme-activity-graph.vercel.app/graph?username=abiboe&bg_color=0a0a0f&color=00ff88&line=00ff88&point=ffffff&area=true&hide_border=true" />
